...
int	main(int argc, char **argv)
{
	...
	{
		count_w = -1;
		while (++count_w < core->img2.width / 2)
		{
			if (count_w % 2)
				core->img2.data[count_h * core->img2.width + count_w] = 0xFFFFFF;
			else
				core->img2.data[count_h * core->img2.width + count_w] = 0xFF0000;
		}
	}
	mlx_put_image_to_window(core->mlx, core->win, core->img2.ptr, 50, 50);
